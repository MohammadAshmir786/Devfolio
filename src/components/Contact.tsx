    ...
    <section id="contact" className="py-16 md:py-24 relative">
      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
          <motion.div
            className="bg-black/30 backdrop-blur-md rounded-xl p-8 border border-white/10 h-full"
          ...
          >
            ...
            <p className="text-foreground/80 mb-6">
              I’m always open to connecting for collaboration, exciting
              projects, career opportunities, or even brainstorming creative
              ideas. Don’t hesitate to drop a message!
            </p>
