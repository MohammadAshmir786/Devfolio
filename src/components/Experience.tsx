  ...
  return (
    <motion.div
      ...
      transition={{
        ...
        delay: index * motionConfig.childStagger,
      }}
    >
...
const Experience: React.FC = () => {
  const experiences = [
    ...
    },
    {
      ...
      skills: ["JavaScript", "jQuery", "AJAX", "HTML5", "CSS3", "Cryptography"],
    },
    {
      ...
      <div className="container px-4 mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6 relative">
            <span className="inline-block">Professional Experience</span>
            <span className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-primary"></span>
          </h2>

          <div className="text-lg text-foreground/80">
            My professional journey in web development and AI/ML integration.
          </div>
        </motion.div>
